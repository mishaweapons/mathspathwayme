...
alert("Sent a request to change the icon. Please note some sites will not let you do this due to their security policy. However, the title will change no matter what.")
//
//
//
